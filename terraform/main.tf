...
locals {
  region        = "eu-central-1"
  bucket_name   = "nodeboot-website"
  domain_name   = "nodeboot.io"
}
...
resource "aws_cloudfront_response_headers_policy" "security_headers" {
  name = "nodeboot-Security-Headers"
...
resource "aws_route53_record" "nodeboot" {
